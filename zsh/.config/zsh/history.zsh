...
setopt appendhistory           # commands are added to the history file incrementally
setopt sharehistory            # commands entered in one session are instantly available in another
